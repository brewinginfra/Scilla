...
# Add upstream remote
git remote add upstream https://github.com/brewinginfra/Scilla.git
...
If you have questions about contributing, feel free to join [Blueshift Discord server](https://discord.gg/brewinginfra) ask in the #scilla channel.
